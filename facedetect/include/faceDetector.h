#ifndef _CN_LEANCLOUD_BACKEND_IMAGE_SERVICE_FACE_DETECTOR_H_
#define _CN_LEANCLOUD_BACKEND_IMAGE_SERVICE_FACE_DETECTOR_H_
...
#endif //_CN_LEANCLOUD_BACKEND_IMAGE_SERVICE_FACE_DETECTOR_H_
