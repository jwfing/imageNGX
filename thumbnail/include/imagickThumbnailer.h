#ifndef AVOS_BACKEND_IMAGE_SERVICE_IMAGICK_THUMBNAILER_INCLUDE_H_
#define AVOS_BACKEND_IMAGE_SERVICE_IMAGICK_THUMBNAILER_INCLUDE_H_
...
#endif // end of AVOS_BACKEND_IMAGE_SERVICE_IMAGICK_THUMBNAILER_INCLUDE_H_
