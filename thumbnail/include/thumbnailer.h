#ifndef _CN_LEANCLOUD_BACKEND_IMAGE_SERVICE_THUMBNAILER_INCLUDE_H_
#define _CN_LEANCLOUD_BACKEND_IMAGE_SERVICE_THUMBNAILER_INCLUDE_H_
...
#endif //end of _CN_LEANCLOUD_BACKEND_IMAGE_SERVICE_THUMBNAILER_INCLUDE_H_
