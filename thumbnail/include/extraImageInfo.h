#ifndef AVOS_BACKEND_IMAGE_SERVICE_EXTRA_IMAGE_INFO_H
#define AVOS_BACKEND_IMAGE_SERVICE_EXTRA_IMAGE_INFO_H
...
#endif //AVOS_BACKEND_IMAGE_SERVICE_EXTRA_IMAGE_INFO_H
