#ifndef AVOS_BACKEND_IMAGE_SERVICE_IMAGIC_IMAGE_OPERATOR_H_
#define AVOS_BACKEND_IMAGE_SERVICE_IMAGIC_IMAGE_OPERATOR_H_
...
#endif // end of AVOS_BACKEND_IMAGE_SERVICE_IMAGIC_IMAGE_OPERATOR_H_
